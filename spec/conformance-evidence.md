...
| [Energy, Proposals, and Trackers](energy-proposals-and-trackers.md) | proposal probabilities, named acceptance laws, volume recomputation | `integration/conformance/test_reference_semantics.jl` | component reference implementations | Foundation present |
| [Lifecycle](lifecycle.md) | copy-before-commit lifecycle transaction validation | `integration/conformance/test_reference_semantics.jl` | event and lifecycle adapters | Foundation present |
...
| [Numerical and Cross-Backend Semantics](numerical-and-cross-backend-semantics.md) | `ConformanceCase`, statistical procedure tiers | `integration/conformance/test_harness.jl` | precision/backend matrix | Foundation present; adapters pending |

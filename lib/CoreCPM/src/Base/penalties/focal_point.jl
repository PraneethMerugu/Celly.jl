...
function update_sweep_auxiliary!(pen::FocalPointSpringPenalty, u::AbstractCPMState,
        p::CPMParameters, cache::CPMCache, T_val, dt)
...
function update_step_auxiliary!(pen::HSTFocalPointPenalty, u::AbstractCPMState,
        p::CPMParameters, cache::CPMCache, T_val, dt)

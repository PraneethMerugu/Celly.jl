...
@testset "3D Length Penalty Validation" begin
    ...
    p = CPMParameters(VonNeumannTopology{3}(), penalties, ())
    ...
    CoreCPM.initialize_com_anchors!(u0, p, cache)
    
    # Pre-simulate update auxiliary fields to test 3D COM and Inertia logic
    CoreCPM.update_step_auxiliary!(penalties[2], u0, p, cache, T_val, 1.0f0)

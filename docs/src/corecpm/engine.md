# [Monte Carlo Algorithms](@id corecpm-engine)

CoreCPM provides four Monte Carlo update algorithms. They all implement the same
...
visited. This is the textbook CPM algorithm.

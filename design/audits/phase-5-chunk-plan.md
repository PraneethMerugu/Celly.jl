...
Status: Active — CPU/Metal execution foundation implemented; CUDA/ROCm qualification pending
...
| --- | --- | --- |
| 1. D2 RNG qualification | Implemented; CPU and Metal qualified, CUDA/ROCm pending | Random123 known answers, address vectors, CPU/Metal/ROCm/CUDA raw-word probes |
| 2. Backend contract | Implemented foundation; CUDA/ROCm RNG claims deliberately withheld | Backend reports and negative tests compile without backend tests in scientific code |
| 3. Compiled state | CPU and Metal lowering, Adapt, validation, and round trip pass | CPU and GPU snapshots agree with logical state |

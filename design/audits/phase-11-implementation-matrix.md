...
| Contract area | Required public spelling | Required evidence | Status |
|---|---|---|---|
| Validation | `validate`, `isvalid`, structured exceptions | staged, accumulated, source-located diagnostics | accumulated source-located DSL diagnostics cover declaration reads, parameter scope, draw identity/domain, scalar arity, phase cycles, duplicate writers, and unordered hazards; query/conversion diagnostics remain |

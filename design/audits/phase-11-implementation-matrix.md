...
| Draws | `draw`, `RandomDraw`, stable labels | unique semantic addresses, duplicates rejected, no authoring-time RNG | typed distributions, stable labels, duplicate diagnostics, and Bernoulli runtime lowering implemented; remaining distributions/runtime coverage pending |
